...
export const SCHEDULE = [
  ...
  { time: '12:40 PM – 1:25 PM', label: 'Round 2', description: 'Advanced Type Patterns & Scenarios', type: 'round' as const },
  { time: '1:25 PM – 2:10 PM', label: 'Lunch Break', description: '', type: 'break' as const },
  { time: '2:10 PM – 3:10 PM', label: 'Round 3', description: 'React + TypeScript Coding Challenge', type: 'round' as const },
  { time: '3:10 PM – 3:20 PM', label: 'Break', description: '', type: 'break' as const },
  { time: '3:20 PM – 4:10 PM', label: 'Round 4', description: 'TypeScript Configuration Mastery', type: 'round' as const },
  { time: '4:10 PM – 4:20 PM', label: 'Break', description: '', type: 'break' as const },
  { time: '4:20 PM – 5:10 PM', label: 'Round 5', description: 'Full Integration Challenge', type: 'round' as const },
];
